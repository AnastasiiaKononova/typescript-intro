...
for(let num of numbers3) {
  if (num < 0) {
    firstNegative = num;
    break; // виходимо з циклу, знайшовши перше від'ємне число
  }
}
...
const discount: number = 10; // 10% sale
const discountAmount: number = (discount / 100) * item.price;
const finalPrice: number = item.price - discountAmount;

// console.log(`Вартість покупки з урахуванням знижки: ${finalPrice.toFixed(2)}`);
/*
Задача 5.
